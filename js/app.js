// hide preloader
// all imgaes scripts links have finished loading
...
UI.prototype.showFeedback = function (text, type) {
  const feedback = document.querySelector(".drink-form__feeback");
  if (type === "success") {
...
UI.prototype.removeAlert = function (type) {
  setTimeout(function () {
    document.querySelector(".drink-form__feeback").classList.remove(type);
  }, 3000);
};
